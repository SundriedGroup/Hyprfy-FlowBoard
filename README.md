...
- Add as many independent posts as required to any day
- Each day is one summary box for Day, Date, Topic, and What’s happening, followed by a single flat list of posts
- Workflow columns have been removed; each platform-specific post is an independent coloured box
